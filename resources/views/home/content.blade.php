    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{asset('fe/img/clio.jpg')}}" alt="">
                    </div>
                    <div class="shop-body">
                        <span class="text-white font-lalezar fs-22">Thương hiệu <br>CLIO</span>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{asset('fe/img/loreal.jpeg')}}" alt="">
                    </div>
                    <div class="shop-body">
                        <span class="text-white font-lalezar fs-22">Thương hiệu <br>L'ORÉAL</span>
                    </div>
                </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{asset('fe/img/goodal.jpeg')}}" alt="">
                    </div>
                    <div class="shop-body">
                        <h3 class="text-white font-lalezar fs-22">Thương hiệu <br>GOODAL</h3>
                    </div>
                </div>
            </div>
            <!-- /shop -->
