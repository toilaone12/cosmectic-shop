...
class ProductController extends Controller
{
    ...
    function detail(Request $request)
    {
        ...
        if ($product) {
            ...
            return view('product.detail', compact('product', 'title', 'count', 'carts', 'listParentCate', 'listChildrenCate', 'idCate', 'productRelated', 'reviews', 'avg', 'countRating', 'arrRating', 'countWhiteList'));
        } else {
